...
class Serp_Triangle extends ChaosGameAlgorithm
        {
        public static int DISTANCE_FRACTION = 2;
        //private volatile bool Done;

// LA FUNZIONE CHE VERRà RICHIAMATA FUORI
public static void Draw(final Canvas F1, final int X, final int Y, final int p1x, final int p1y, final int p2x, final int p2y, final int p3x, final int p3y)
        {
        ...
        final int i = 0;
            ...
            Thread t = new Thread(new Runnable() {
                public void run() {
                    TrueDraw(F1,X, Y, p1x, p1y, p2x, p2y, p3x, p3y, i);
                }
            });
...
static void TrueDraw(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int i)
        {
        Random r = new Random();// MOLTO IMPORTANTE: IL RANDOM VA DICHIARATO DENTRO LA FUNZIONE TRUE, ALTRIMENTI NON FUNZIONA NULLA
        for (int j = 0; j < 1000; j++)
        {
        DrawHelper(F1,X, Y, p1x, p1y, p2x, p2y, p3x, p3y, i, r);
        }

        }
//100 punti, FA TUTTO IL LAVORO
static void DrawHelper(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int i, Random r)
        {
...
public Serp_Triangle()
        {
        F1 = new Canvas();
        X = 0;Y=0;p1x = 0; p1y = 500; p2x = 1000; p2y = 1000; p3x = 1000; p3y = 1000;i=0;
        }

public Serp_Triangle(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y)
 ...
 */
class T_Square : ChaosGameAlgorithm
        {



//chiama il true con una thread
public static void Draw(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y)
        {
        //Lambda
        int i = 0;
        int buf = 0;
        ...
        o =>
        {
        TrueDraw(F1,X, Y, p1x, p1y, p2x, p2y, p3x, p3y, p4x, p4y, i, buf);

        });
        t.Start();
        }
//chiama 100 volte l'helper (totale 10 000 punti)
static void TrueDraw(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int i, int buf)
        {
        Random r = new Random();//STESSA CONSIDERAZIONE DI PRIMA
        for (int j = 0; j < 1000; j++)
        {
        DrawHelper(F1,X, Y, p1x, p1y, p2x, p2y, p3x, p3y, p4x, p4y, i, buf, r);
        }
        }
//100 punti
static void DrawHelper(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int i, int buf, Random r)
        {
...
class Pent_Serp
{
    ...
    //chiama il true con una thread
    public static void Draw(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y)
    {
        int i = 0, buf = 0;
        //Lambda
        Thread t = new Thread(
                o =>
                {
                        TrueDraw(F1,X, Y, p1x, p1y, p2x, p2y, p3x, p3y, p4x, p4y, p5x, p5y, i, buf);
    ...
    //chiama 1000 volte l'helper (totale 100 000 punti)
    static void TrueDraw(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y, int i, int buf)
    {
        Random r = new Random();//STESSA CONSIDERAZIONE DI PRIMA
        for (int j = 0; j < 1000; j++)
        {
            DrawHelper(F1,X, Y, p1x, p1y, p2x, p2y, p3x, p3y, p4x, p4y, p5x, p5y, i, buf, r);
        }
    }

    //100 punti
    static void DrawHelper(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y, int i, int buf, Random r)
    {
        ...
        switch (scelta)
        {
            ...
            case 5:
            {
                nextPx = ((p5x + X) / DISTANCE_FRACTION);
                nextPy = ((p5y + Y) / DISTANCE_FRACTION);
                break;
            }
            default:
            {
...
class Star
{
    ...
    public static void Draw(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y)
    {
        ...
        Thread t = new Thread(
                o =>
                {
                        TrueDraw(F1,X, Y, p1x, p1y, p2x, p2y, p3x, p3y, p4x, p4y, p5x, p5y, i);
    ...
    //chiama 1000 volte l'helper (totale 100 000 punti)
    static void TrueDraw(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y, int i)
    {
        Random r = new Random();//STESSA CONSIDERAZIONE DI PRIMA
        for (int j = 0; j < 1000; j++)
        {
            DrawHelper(F1,X, Y, p1x, p1y, p2x, p2y, p3x, p3y, p4x, p4y, p5x, p5y, i, 6, 6, false, r);
        }
    }

    //100 punti
    static void DrawHelper(Canvas F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y, int i, int buf1, int buf2, bool volta, Random r)
    {
...
class Barnsley_Fern
{
    public static void Draw(Canvas F1, float X, float Y)
    {
        //Lambda
        Thread t = new Thread(
                o =>
    ...
    //chiama 1000 volte l'helper (totale 100 000 punti)
    static void TrueDraw(Canvas F1,  float X, float Y)
    {
        Random r = new Random();//STESSA CONSIDERAZIONE DI PRIMA
        double x = 0;
        double y = 0;
