...
class Serp_Triangle : ChaosGameAlgorithm
{
    public static int DISTANCE_FRACTION = 2;
    //private volatile bool Done;

    // LA FUNZIONE CHE VERRà RICHIAMATA FUORI
    public static void Draw(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y)
    {
   ...
   o =>
   {
    ...
    static void TrueDraw(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int i)
    {
    ...
    static void DrawHelper(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int i, Random r)
    {
    ...
    public Serp_Triangle(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y)
...
class T_Square : ChaosGameAlgorithm
{
    ...
    public static void Draw(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y)
    {
        //Lambda
        int i = 0;
        int buf = 0;
   ...
   //chiama 100 volte l'helper (totale 10 000 punti)
    static void TrueDraw(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int i, int buf)
    {
    ...
    //100 punti
    static void DrawHelper(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int i, int buf, Random r)
    {
...
class Pent_Serp 
{
    ...
    //chiama il true con una thread
    public static void Draw(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y)
    {
        int i = 0, buf = 0;
        //Lambda
        Thread t = new Thread(
   o =>
   {
    ...
    //chiama 1000 volte l'helper (totale 100 000 punti)
    static void TrueDraw(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y, int i, int buf)
    {
        Random r = new Random();//STESSA CONSIDERAZIONE DI PRIMA
        for (int j = 0; j < 1000; j++)
        {
    ...
    //100 punti
    static void DrawHelper(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y, int i, int buf, Random r)
    {
...
{ 
   ...
   o =>
   {
    ...
    //chiama 1000 volte l'helper (totale 100 000 punti)
    static void TrueDraw(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y, int i)
    {
        Random r = new Random();//STESSA CONSIDERAZIONE DI PRIMA
        for (int j = 0; j < 1000; j++)
        {
    ...
    //100 punti
    static void DrawHelper(Form F1,int X, int Y, int p1x, int p1y, int p2x, int p2y, int p3x, int p3y, int p4x, int p4y, int p5x, int p5y, int i, int buf1, int buf2, bool volta, Random r)
    {
...
class Barnsley_Fern
{
    public static void Draw(Form F1, float X, float Y)
    {
        //Lambda
        Thread t = new Thread(
   o =>
   {
    ...
    //chiama 1000 volte l'helper (totale 100 000 punti)
    static void TrueDraw(Form F1,  float X, float Y)
    {
        Random r = new Random();//STESSA CONSIDERAZIONE DI PRIMA
        double x = 0;
        double y = 0;
